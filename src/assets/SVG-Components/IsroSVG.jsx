...
const IsroSVG = (props) => {
  const isro = (
    <svg
      ...
      viewBox="0 0 311.89 300"
    >
      <g id="Group_21653" data-name="Group 21653">
        <path
          id="Path_26807"
          data-name="Path 26807"
          d="M299.52,217.35H289.27a6.86,6.86,0,0,1-6.87-6.87V201.8h10.25a6.86,6.86,0,0,1,6.87,6.87ZM275.36,193.2h-1.75A32.71,32.71,0,0,0,306.28,226h1.65A32.76,32.76,0,0,0,275.36,193.2Z"
        />
        <path
          id="Path_26808"
          data-name="Path 26808"
          d="M170.6,181.15v6.65h38.66c-15,0-20.51,20.55-20.51,20.55,31.22,0,31.07,10.35,31.07,10.35H197.15l-7.55,7.55h26.31c12.36-8.95,11.31-14,11.31-14a6.86,6.86,0,0,0-.5-2.65A15.65,15.65,0,0,0,215.63,202,69.24,69.24,0,0,0,199,200.35l1.6-2.55a7.15,7.15,0,0,1,7-4.14,64.28,64.28,0,0,1,15.31,6.65l7.51-7.85a89.33,89.33,0,0,0-8.61-4.65h90.06v-6.66Z"
        />
        <rect
          id="Rectangle_5116"
        ...
        <path
          ...
          d="M262.21,194.3s-7.21-2.5-17.47,6.87v-8.12h-10v33.22h10V203.6s11-5.3,15,2.55a15.34,15.34,0,0,1,1,7.25l8-7.65S269.46,196.1,262.21,194.3Z"
        />
        <circle
          id="Ellipse_1662"
